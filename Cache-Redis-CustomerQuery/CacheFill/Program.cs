...
namespace CacheFill
{
    class Program
    {
        ...
        const string mCacheUrl = "customerquerycache.redis.cache.windows.net";
        const string mCachePassword = "4/QIPUxAMwbb5e7cQXRiR2S7KSbaMS4yFrfIM0IO41k=";
        const string mCacheUrl2 = "productquerycache.redis.cache.windows.net";
        const string mCachePassword2 = "jH2EXEDhfYAG82LzvhZvX0EPRzE8nzyKbrApC1p83wQ=";
